...
INSERT INTO puzzles(nombre, descripcion, precio,  numeroPiezas, categoria, id) VALUES('Fortaleza', 'Puzzle de 500 Piezas',15.00, 500 , "500 Piezas", NEXTVAL('hibernate_sequence'));
INSERT INTO puzzles(nombre, descripcion, precio,  numeroPiezas, categoria, id) VALUES('Pirata', 'Puzzle de 1000 Piezas',17.00, 1000 , "1000 Piezas", NEXTVAL('hibernate_sequence'));
INSERT INTO puzzles(nombre, descripcion, precio,  numeroPiezas, categoria, id) VALUES('Baile', 'Puzzle de 2000 Piezas',19.00, 2000 , "2000 Piezas", NEXTVAL('hibernate_sequence'));
INSERT INTO puzzles(nombre, descripcion, precio,  numeroPiezas, categoria, id) VALUES('Castillo', 'Puzzle de 3000 Piezas',21.00, 3000 , "3000 Piezas", NEXTVAL('hibernate_sequence'));
